...
def cal_acc(args, new_projects, new_signals, impedence='time', potentials=['job','populations'], by_orig=True):
    """
    ...
    for orig in tqdm(destinations):
        ...
        for potential in potentials: # do multiple destination types here instead of re-solving the lengths every time
